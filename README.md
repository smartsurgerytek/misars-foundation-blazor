...
```bash
dotnet dev-certs https -v -ep openiddict.pfx -p efa27397-a09d-4543-a8f7-ef38819edecf
```

> `efa27397-a09d-4543-a8f7-ef38819edecf` is the password of the certificate, you can change it to any password you want.
