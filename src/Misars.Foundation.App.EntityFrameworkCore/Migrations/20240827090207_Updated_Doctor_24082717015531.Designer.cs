...
namespace Misars.Foundation.App.Migrations
{
    ...
    [Migration("20240827090207_Updated_Doctor_24082717015531")]
    partial class Updated_Doctor_24082717015531
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Misars.Foundation.App.Filemanagements.Filemanagement", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("TEXT");
                    ...
                    b.ToTable("AppFilemanagements", (string)null);
                });
            ...
            modelBuilder.Entity("Misars.Foundation.App.Patients.Patient", b =>
                {
                    ...
                    b.Property<string>("EmergencyConstact")
                        .HasMaxLength(100)
                        .HasColumnType("TEXT")
                        .HasColumnName("EmergencyConstact");
                    ...
                    b.Property<string>("InsuranceInformation")
                        .HasMaxLength(100)
                        .HasColumnType("TEXT")
                        .HasColumnName("InsuranceInformation");
            ...
            modelBuilder.Entity("Misars.Foundation.App.SurgeryTimetables.SurgeryTimetable", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("TEXT");
                    ...
                    b.Property<string>("OperatingrRoomNumber")
                        .HasMaxLength(100)
                        .HasColumnType("TEXT")
                        .HasColumnName("OperatingrRoomNumber");
                    ...
                    b.ToTable("AppSurgeryTimetables", (string)null);
                });
            ...
            modelBuilder.Entity("Misars.Foundation.App.SurgeryTimetables.SurgeryTimetable", b =>
                {
                    ...
                    b.HasOne("Misars.Foundation.App.Patients.Patient", null)
                        .WithMany()
